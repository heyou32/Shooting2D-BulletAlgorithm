...
public class CollisionState : CollisionBase2D, IScoreBase
{
    ...
    public virtual void Kill()
    {
        ...
        {
            if (transform.parent != null && destroyParent) Destroy(gameObject.transform.parent.gameObject); else BulletPool.Instance.ReturnBullet(gameObject);
        }
    }
